...
def main():
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        model = model_class.from_pretrained(args.output_dir, device=args.device, entity_emb_mat=entity_emb_mat, relation_emb_mat=relation_emb_mat)
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model = model_class.from_pretrained(checkpoint, device=args.device, entity_emb_mat=entity_emb_mat, relation_emb_mat=relation_emb_mat)
            model.to(args.device)
