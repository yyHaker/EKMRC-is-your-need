...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='EKMRC/retrieve_concepts/retrieve_wordnet/output_record', help='output directory')
    ...
    fin = open('EKMRC/retrieve_concepts/retrieve_wordnet/wordnet-mlj12-definitions.txt')
    for line in fin:
