...
def main():
    ...
    parser.add_argument('--train_token', type=str, default='EKMRC/data/ReCoRD_tokenization/tokens_self/train.tokenization.cased.data', help='token file of train set')
    parser.add_argument('--eval_token', type=str, default='EKMRC/data/ReCoRD_tokenization/tokens_self/dev.tokenization.cased.data', help='token file of dev set')
    parser.add_argument('--score_threshold', type=float, default=0.9, help='only keep generalizations relations with score >= threshold')    
    parser.add_argument('--output_dir', type=str, default='EKMRC/data/retrived_kb_data/nell_record_self', help='output directory')
    ...
    concept_set = set()
    with open('EKMRC/kgs/NELL/nell/nell_concept_list.txt') as fin:
        for line in fin:
    ...
    fin = open('EKMRC/kgs/NELL/nell/NELL.08m.1115.esv.csv')
    nell_ent_to_cpt = {}
    ...
    for line in fin:
        ...
        if items[1] != 'generalizations' and "concept" not in items[1]:
            print(items[1])
