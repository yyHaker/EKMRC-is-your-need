...
def main():
    ...
    parser.add_argument('--train_token', type=str, default='EKMRC/data/ReCoRD/tokenization_self/bert-large-uncased-wwm/train.tokenization.uncased.data', 
                                                                                help='token file of train set')
    parser.add_argument('--eval_token', type=str, default='EKMRC/data/ReCoRD/tokenization_self/bert-large-uncased-wwm/dev.tokenization.uncased.data',
                                                                                help='token file of dev set')
    parser.add_argument('--output_dir', type=str, default='EKMRC/kgs/wordnet/retrieve_wordnet_res/bert-large-uncased-wwm', 
    ...
    fin = open('EKMRC/kgs/wordnet/wordnet/wordnet-mlj12-definitions.txt')
    for line in fin:
